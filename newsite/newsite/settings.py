...
TEMPLATES = [
    {
        ...
        'DIRS': [r'C:/Users/hp\Desktop/Program\Django-new-venv/newsite/main/template/main',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
## ---> For deploy tha project to productions create 'Profile' at the same level as manage.py